...
resource "aws_cloudwatch_metric_alarm" "alarm" {
  ...
  alarm_actions =  concat(local.rackspace_alarm_actions[local.rackspace_alarm_config],local.customer_alarm_actions[local.customer_alarm_config])
  ok_actions = concat(local.rackspace_alarm_actions[local.rackspace_alarm_config],local.customer_alarm_actions[local.customer_ok_config])
}
